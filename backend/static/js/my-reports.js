...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function openModal(id) {
    ...
    try {
      ...
      const reportedDate = tl?.querySelector('.tl-step[data-step="reported"] .tl-date');
      ...
      if (reportedDate) reportedDate.textContent = fmtDate(issue.reported_at);
      if (progressDate) progressDate.textContent = fmtDate(issue.in_progress_at);
      if (resolvedDate) resolvedDate.textContent = fmtDate(issue.resolved_at);
